...
public class BaseController {
	...
	public static Map<String, String> getCurrentInfo(){
		String id="";
		String username="";
		if(SecurityUtils.getSubject().getPrincipal() instanceof MemberInfo){
			MemberInfo memberInfo=(MemberInfo) SecurityUtils.getSubject().getPrincipal();
			username=memberInfo.getMemAccount();
			id=memberInfo.getId();
		}
